...
export default async function Home() {
  ...
  return (
    <main className="p-4 md:p-10">
      <nav className="w-full flex justify-between px-4 md:px-20">
        <div className="flex items-center gap-10">
          ...
          <Link
            href={"/home"}
            className="text-xl font-semibold text-[#7a7a7a] hover:text-white transition hidden md:inline-block"
          >
            Books
          </Link>
          <Link
      ...
      <section className="mt-36 flex flex-col items-center">
        ...
        <h1 className="text-center text-[3rem] md:text-[4.5rem] font-bold leading-[4rem] md:leading-[5.4rem] mt-7">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4 mt-4">
          <span className="text-center md:text-end">For readers</span>
          <Button className="bg-[#A98FCB] hover:bg-[#584177] text-white">
            Start Reading
          </Button>
          <Button className="bg-white">Start Publishing</Button>
          <span className="text-center md:text-start">For sellers</span>
        </div>
        ...
        <div className="mt-10">
          <Image
            ...
            height={1080}
            width={1920}
            className="object-cover w-[65%] rounded-md"
          />
        </div>
      </section>
    </main>
